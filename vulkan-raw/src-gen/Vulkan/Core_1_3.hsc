...
##endif
  ...
  , VkFlags64
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_3_FEATURES
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_3_PROPERTIES
  , VkPhysicalDeviceVulkan13Features (..)
  , VkPhysicalDeviceVulkan13Properties (..)

  -- | Promoted from VK_EXT_pipeline_creation_feedback (extension 193)
  , pattern VK_STRUCTURE_TYPE_PIPELINE_CREATION_FEEDBACK_CREATE_INFO
  , VkPipelineCreationFeedbackFlagBits
  , pattern VK_PIPELINE_CREATION_FEEDBACK_VALID_BIT
  , pattern VK_PIPELINE_CREATION_FEEDBACK_VALID_BIT_EXT
  , pattern VK_PIPELINE_CREATION_FEEDBACK_APPLICATION_PIPELINE_CACHE_HIT_BIT
  , pattern VK_PIPELINE_CREATION_FEEDBACK_APPLICATION_PIPELINE_CACHE_HIT_BIT_EXT
  , pattern VK_PIPELINE_CREATION_FEEDBACK_BASE_PIPELINE_ACCELERATION_BIT
  ...
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_TERMINATE_INVOCATION_FEATURES
  , VkPhysicalDeviceShaderTerminateInvocationFeatures (..)

  -- | Promoted from VK_EXT_tooling_info (extension 246)
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TOOL_PROPERTIES
  , VkToolPurposeFlagBits
  , pattern VK_TOOL_PURPOSE_VALIDATION_BIT
  , pattern VK_TOOL_PURPOSE_VALIDATION_BIT_EXT
  , pattern VK_TOOL_PURPOSE_PROFILING_BIT
  , pattern VK_TOOL_PURPOSE_PROFILING_BIT_EXT
  , pattern VK_TOOL_PURPOSE_TRACING_BIT
  , pattern VK_TOOL_PURPOSE_TRACING_BIT_EXT
  , pattern VK_TOOL_PURPOSE_ADDITIONAL_FEATURES_BIT
  , pattern VK_TOOL_PURPOSE_ADDITIONAL_FEATURES_BIT_EXT
  , pattern VK_TOOL_PURPOSE_MODIFYING_FEATURES_BIT
  , pattern VK_TOOL_PURPOSE_MODIFYING_FEATURES_BIT_EXT
  , VkToolPurposeFlags
  , VkPhysicalDeviceToolProperties (..)
  , VkGetPhysicalDeviceToolProperties
  , vkFunGetPhysicalDeviceToolProperties
##if CORE_1_3
  , vkGetPhysicalDeviceToolProperties
...
##endif
  ...
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DEMOTE_TO_HELPER_INVOCATION_FEATURES
  , VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures (..)

  -- | Promoted from VK_KHR_shader_non_semantic_info (extension 294)

  -- | Promoted from VK_EXT_private_data (extension 296)
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIVATE_DATA_FEATURES
  , pattern VK_STRUCTURE_TYPE_DEVICE_PRIVATE_DATA_CREATE_INFO
  , pattern VK_STRUCTURE_TYPE_PRIVATE_DATA_SLOT_CREATE_INFO
  , pattern VK_OBJECT_TYPE_PRIVATE_DATA_SLOT
  ...
  , vkFunCreatePrivateDataSlot
##if CORE_1_3
  , vkCreatePrivateDataSlot
  , vkCreatePrivateDataSlotUnsafe
##endif
  , VkDestroyPrivateDataSlot
  , vkFunDestroyPrivateDataSlot
##if CORE_1_3
  , vkDestroyPrivateDataSlot
...
##endif
  ...
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_CREATION_CACHE_CONTROL_FEATURES
  , VkPhysicalDevicePipelineCreationCacheControlFeatures (..)
  , pattern VK_PIPELINE_CREATE_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BIT
  , pattern VK_PIPELINE_CREATE_EARLY_RETURN_ON_FAILURE_BIT
  , pattern VK_PIPELINE_COMPILE_REQUIRED
  , pattern VK_PIPELINE_CACHE_CREATE_EXTERNALLY_SYNCHRONIZED_BIT

  -- | Promoted from VK_KHR_synchronization2 (extension 315)
  , pattern VK_STRUCTURE_TYPE_MEMORY_BARRIER_2
  , pattern VK_STRUCTURE_TYPE_BUFFER_MEMORY_BARRIER_2
  , pattern VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER_2
  , pattern VK_STRUCTURE_TYPE_DEPENDENCY_INFO
  , pattern VK_STRUCTURE_TYPE_SUBMIT_INFO_2
  , pattern VK_STRUCTURE_TYPE_SEMAPHORE_SUBMIT_INFO
  , pattern VK_STRUCTURE_TYPE_COMMAND_BUFFER_SUBMIT_INFO
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SYNCHRONIZATION_2_FEATURES
  , pattern VK_EVENT_CREATE_DEVICE_ONLY_BIT
  , pattern VK_IMAGE_LAYOUT_READ_ONLY_OPTIMAL
  , pattern VK_IMAGE_LAYOUT_ATTACHMENT_OPTIMAL
  , pattern VK_PIPELINE_STAGE_NONE
  , pattern VK_ACCESS_NONE
  , VkPipelineStageFlags2
  , VkPipelineStageFlagBits2
  , pattern VK_PIPELINE_STAGE_2_NONE
  , pattern VK_PIPELINE_STAGE_2_NONE_KHR
  , pattern VK_PIPELINE_STAGE_2_TOP_OF_PIPE_BIT
  , pattern VK_PIPELINE_STAGE_2_TOP_OF_PIPE_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_DRAW_INDIRECT_BIT
  , pattern VK_PIPELINE_STAGE_2_DRAW_INDIRECT_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_VERTEX_INPUT_BIT
  , pattern VK_PIPELINE_STAGE_2_VERTEX_INPUT_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_VERTEX_SHADER_BIT
  , pattern VK_PIPELINE_STAGE_2_VERTEX_SHADER_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_TESSELLATION_CONTROL_SHADER_BIT
  , pattern VK_PIPELINE_STAGE_2_TESSELLATION_CONTROL_SHADER_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_TESSELLATION_EVALUATION_SHADER_BIT
  , pattern VK_PIPELINE_STAGE_2_TESSELLATION_EVALUATION_SHADER_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_GEOMETRY_SHADER_BIT
  , pattern VK_PIPELINE_STAGE_2_GEOMETRY_SHADER_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT
  , pattern VK_PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_EARLY_FRAGMENT_TESTS_BIT
  , pattern VK_PIPELINE_STAGE_2_EARLY_FRAGMENT_TESTS_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_LATE_FRAGMENT_TESTS_BIT
  , pattern VK_PIPELINE_STAGE_2_LATE_FRAGMENT_TESTS_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT
  , pattern VK_PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_COMPUTE_SHADER_BIT
  , pattern VK_PIPELINE_STAGE_2_COMPUTE_SHADER_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_ALL_TRANSFER_BIT
  , pattern VK_PIPELINE_STAGE_2_ALL_TRANSFER_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_TRANSFER_BIT
  , pattern VK_PIPELINE_STAGE_2_TRANSFER_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_BOTTOM_OF_PIPE_BIT
  , pattern VK_PIPELINE_STAGE_2_BOTTOM_OF_PIPE_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_HOST_BIT
  , pattern VK_PIPELINE_STAGE_2_HOST_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_ALL_GRAPHICS_BIT
  , pattern VK_PIPELINE_STAGE_2_ALL_GRAPHICS_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT
  , pattern VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_COPY_BIT
  , pattern VK_PIPELINE_STAGE_2_COPY_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_RESOLVE_BIT
  , pattern VK_PIPELINE_STAGE_2_RESOLVE_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_BLIT_BIT
  , pattern VK_PIPELINE_STAGE_2_BLIT_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_CLEAR_BIT
  , pattern VK_PIPELINE_STAGE_2_CLEAR_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_INDEX_INPUT_BIT
  , pattern VK_PIPELINE_STAGE_2_INDEX_INPUT_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_VERTEX_ATTRIBUTE_INPUT_BIT
  , pattern VK_PIPELINE_STAGE_2_VERTEX_ATTRIBUTE_INPUT_BIT_KHR
  , pattern VK_PIPELINE_STAGE_2_PRE_RASTERIZATION_SHADERS_BIT
  , pattern VK_PIPELINE_STAGE_2_PRE_RASTERIZATION_SHADERS_BIT_KHR
  , VkAccessFlags2
  , VkAccessFlagBits2
  , pattern VK_ACCESS_2_NONE
  , pattern VK_ACCESS_2_NONE_KHR
  , pattern VK_ACCESS_2_INDIRECT_COMMAND_READ_BIT
  , pattern VK_ACCESS_2_INDIRECT_COMMAND_READ_BIT_KHR
  , pattern VK_ACCESS_2_INDEX_READ_BIT
  , pattern VK_ACCESS_2_INDEX_READ_BIT_KHR
  , pattern VK_ACCESS_2_VERTEX_ATTRIBUTE_READ_BIT
  , pattern VK_ACCESS_2_VERTEX_ATTRIBUTE_READ_BIT_KHR
  , pattern VK_ACCESS_2_UNIFORM_READ_BIT
  , pattern VK_ACCESS_2_UNIFORM_READ_BIT_KHR
  , pattern VK_ACCESS_2_INPUT_ATTACHMENT_READ_BIT
  , pattern VK_ACCESS_2_INPUT_ATTACHMENT_READ_BIT_KHR
  , pattern VK_ACCESS_2_SHADER_READ_BIT
  , pattern VK_ACCESS_2_SHADER_READ_BIT_KHR
  , pattern VK_ACCESS_2_SHADER_WRITE_BIT
  , pattern VK_ACCESS_2_SHADER_WRITE_BIT_KHR
  , pattern VK_ACCESS_2_COLOR_ATTACHMENT_READ_BIT
  , pattern VK_ACCESS_2_COLOR_ATTACHMENT_READ_BIT_KHR
  , pattern VK_ACCESS_2_COLOR_ATTACHMENT_WRITE_BIT
  , pattern VK_ACCESS_2_COLOR_ATTACHMENT_WRITE_BIT_KHR
  , pattern VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_READ_BIT
  , pattern VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_READ_BIT_KHR
  , pattern VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT
  , pattern VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT_KHR
  , pattern VK_ACCESS_2_TRANSFER_READ_BIT
  , pattern VK_ACCESS_2_TRANSFER_READ_BIT_KHR
  , pattern VK_ACCESS_2_TRANSFER_WRITE_BIT
  , pattern VK_ACCESS_2_TRANSFER_WRITE_BIT_KHR
  , pattern VK_ACCESS_2_HOST_READ_BIT
  , pattern VK_ACCESS_2_HOST_READ_BIT_KHR
  , pattern VK_ACCESS_2_HOST_WRITE_BIT
  , pattern VK_ACCESS_2_HOST_WRITE_BIT_KHR
  , pattern VK_ACCESS_2_MEMORY_READ_BIT
  , pattern VK_ACCESS_2_MEMORY_READ_BIT_KHR
  , pattern VK_ACCESS_2_MEMORY_WRITE_BIT
  , pattern VK_ACCESS_2_MEMORY_WRITE_BIT_KHR
  , pattern VK_ACCESS_2_SHADER_SAMPLED_READ_BIT
  , pattern VK_ACCESS_2_SHADER_SAMPLED_READ_BIT_KHR
  , pattern VK_ACCESS_2_SHADER_STORAGE_READ_BIT
  , pattern VK_ACCESS_2_SHADER_STORAGE_READ_BIT_KHR
  , pattern VK_ACCESS_2_SHADER_STORAGE_WRITE_BIT
  , pattern VK_ACCESS_2_SHADER_STORAGE_WRITE_BIT_KHR
  , VkMemoryBarrier2 (..)
  ...
  , VkSubmitFlagBits
  , pattern VK_SUBMIT_PROTECTED_BIT
  , pattern VK_SUBMIT_PROTECTED_BIT_KHR
  , VkSubmitFlags
...
##endif
  ...
  , vkFunCmdPipelineBarrier2
##if CORE_1_3
  , vkCmdPipelineBarrier2
  , vkCmdPipelineBarrier2Unsafe
##endif
  , VkCmdWriteTimestamp2
  , vkFunCmdWriteTimestamp2
##if CORE_1_3
  , vkCmdWriteTimestamp2
...
##endif
  ...
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ZERO_INITIALIZE_WORKGROUP_MEMORY_FEATURES
  , VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures (..)

  -- | Promoted from VK_EXT_image_robustness (extension 336)
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_ROBUSTNESS_FEATURES
  , VkPhysicalDeviceImageRobustnessFeatures (..)

  -- | Promoted from VK_KHR_copy_commands2 (extension 338)
  , pattern VK_STRUCTURE_TYPE_COPY_BUFFER_INFO_2
  , pattern VK_STRUCTURE_TYPE_COPY_IMAGE_INFO_2
  , pattern VK_STRUCTURE_TYPE_COPY_BUFFER_TO_IMAGE_INFO_2
  , pattern VK_STRUCTURE_TYPE_COPY_IMAGE_TO_BUFFER_INFO_2
  , pattern VK_STRUCTURE_TYPE_BLIT_IMAGE_INFO_2
  , pattern VK_STRUCTURE_TYPE_RESOLVE_IMAGE_INFO_2
  , pattern VK_STRUCTURE_TYPE_BUFFER_COPY_2
  , pattern VK_STRUCTURE_TYPE_IMAGE_COPY_2
  , pattern VK_STRUCTURE_TYPE_IMAGE_BLIT_2
  , pattern VK_STRUCTURE_TYPE_BUFFER_IMAGE_COPY_2
  , pattern VK_STRUCTURE_TYPE_IMAGE_RESOLVE_2
  , VkCopyBufferInfo2 (..)
  , VkCopyImageInfo2 (..)
...
##endif
  ...
  , vkFunCmdCopyBufferToImage2
##if CORE_1_3
  , vkCmdCopyBufferToImage2
  , vkCmdCopyBufferToImage2Unsafe
##endif
  , VkCmdCopyImageToBuffer2
  , vkFunCmdCopyImageToBuffer2
##if CORE_1_3
  , vkCmdCopyImageToBuffer2
...
##endif
  ...
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_SIZE_CONTROL_PROPERTIES
  , pattern VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_REQUIRED_SUBGROUP_SIZE_CREATE_INFO
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_SIZE_CONTROL_FEATURES
  , pattern VK_PIPELINE_SHADER_STAGE_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT
  , pattern VK_PIPELINE_SHADER_STAGE_CREATE_REQUIRE_FULL_SUBGROUPS_BIT

  -- | Promoted from VK_EXT_inline_uniform_block (STDPROMOTE/PROPLIMCHANGE) (extension 139)
  , pattern VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_FEATURES
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_PROPERTIES
  , pattern VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_INLINE_UNIFORM_BLOCK
  , pattern VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_INLINE_UNIFORM_BLOCK_CREATE_INFO
  ...
  , pattern VK_FORMAT_G8_B8R8_2PLANE_444_UNORM
  , pattern VK_FORMAT_G10X6_B10X6R10X6_2PLANE_444_UNORM_3PACK16
  , pattern VK_FORMAT_G12X4_B12X4R12X4_2PLANE_444_UNORM_3PACK16
  , pattern VK_FORMAT_G16_B16R16_2PLANE_444_UNORM

  -- | Promoted from VK_EXT_4444_formats (does not promote the Feature struct, just the formats) (extension 341)
  , pattern VK_FORMAT_A4R4G4B4_UNORM_PACK16
  , pattern VK_FORMAT_A4B4G4R4_UNORM_PACK16

  -- | Promoted from VK_EXT_texture_compression_astc_hdr (Feature struct is promoted, but becomes optional) (extension 67)
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXTURE_COMPRESSION_ASTC_HDR_FEATURES
  , VkPhysicalDeviceTextureCompressionASTCHDRFeatures (..)
  , pattern VK_FORMAT_ASTC_4x4_SFLOAT_BLOCK
  , pattern VK_FORMAT_ASTC_5x4_SFLOAT_BLOCK
  , pattern VK_FORMAT_ASTC_5x5_SFLOAT_BLOCK
  , pattern VK_FORMAT_ASTC_6x5_SFLOAT_BLOCK
  , pattern VK_FORMAT_ASTC_6x6_SFLOAT_BLOCK
  , pattern VK_FORMAT_ASTC_8x5_SFLOAT_BLOCK
  , pattern VK_FORMAT_ASTC_8x6_SFLOAT_BLOCK
  , pattern VK_FORMAT_ASTC_8x8_SFLOAT_BLOCK
  , pattern VK_FORMAT_ASTC_10x5_SFLOAT_BLOCK
  , pattern VK_FORMAT_ASTC_10x6_SFLOAT_BLOCK
  , pattern VK_FORMAT_ASTC_10x8_SFLOAT_BLOCK
  , pattern VK_FORMAT_ASTC_10x10_SFLOAT_BLOCK
  , pattern VK_FORMAT_ASTC_12x10_SFLOAT_BLOCK
  , pattern VK_FORMAT_ASTC_12x12_SFLOAT_BLOCK

  -- | Promoted from VK_KHR_dynamic_rendering (extension 45)
  , VkCmdBeginRendering
  , vkFunCmdBeginRendering
##if CORE_1_3
  , vkCmdBeginRendering
  , vkCmdBeginRenderingUnsafe
##endif
  , VkCmdEndRendering
  , vkFunCmdEndRendering
##if CORE_1_3
  , vkCmdEndRendering
  , vkCmdEndRenderingUnsafe
##endif
  , pattern VK_STRUCTURE_TYPE_RENDERING_INFO
  , pattern VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_INFO
  , pattern VK_STRUCTURE_TYPE_PIPELINE_RENDERING_CREATE_INFO
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_FEATURES
  , pattern VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_RENDERING_INFO
  , pattern VK_ATTACHMENT_STORE_OP_NONE
  , VkRenderingInfo (..)
  ...
  , VkRenderingFlags
  , VkRenderingFlagBits
  , pattern VK_RENDERING_CONTENTS_SECONDARY_COMMAND_BUFFERS_BIT
  , pattern VK_RENDERING_CONTENTS_SECONDARY_COMMAND_BUFFERS_BIT_KHR
  , pattern VK_RENDERING_SUSPENDING_BIT
  , pattern VK_RENDERING_SUSPENDING_BIT_KHR
  , pattern VK_RENDERING_RESUMING_BIT
  , pattern VK_RENDERING_RESUMING_BIT_KHR

  -- | Promoted from VK_EXT_extended_dynamic_state (Feature struct is not promoted) (extension 268)
  , pattern VK_DYNAMIC_STATE_CULL_MODE
  , pattern VK_DYNAMIC_STATE_FRONT_FACE
  , pattern VK_DYNAMIC_STATE_PRIMITIVE_TOPOLOGY
  , pattern VK_DYNAMIC_STATE_VIEWPORT_WITH_COUNT
  , pattern VK_DYNAMIC_STATE_SCISSOR_WITH_COUNT
  , pattern VK_DYNAMIC_STATE_VERTEX_INPUT_BINDING_STRIDE
  , pattern VK_DYNAMIC_STATE_DEPTH_TEST_ENABLE
  , pattern VK_DYNAMIC_STATE_DEPTH_WRITE_ENABLE
  , pattern VK_DYNAMIC_STATE_DEPTH_COMPARE_OP
  , pattern VK_DYNAMIC_STATE_DEPTH_BOUNDS_TEST_ENABLE
  , pattern VK_DYNAMIC_STATE_STENCIL_TEST_ENABLE
  , pattern VK_DYNAMIC_STATE_STENCIL_OP
  , VkCmdSetCullMode
  , vkFunCmdSetCullMode
##if CORE_1_3
  , vkCmdSetCullMode
...
##endif
  ...
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_INTEGER_DOT_PRODUCT_FEATURES
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_INTEGER_DOT_PRODUCT_PROPERTIES
  , VkPhysicalDeviceShaderIntegerDotProductFeatures (..)
  , VkPhysicalDeviceShaderIntegerDotProductProperties (..)

  -- | Promoted from VK_EXT_texel_buffer_alignment (extension 282)
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXEL_BUFFER_ALIGNMENT_PROPERTIES
  , VkPhysicalDeviceTexelBufferAlignmentProperties (..)

  -- | Promoted from VK_KHR_format_feature_flags2 (extension 361)
  , pattern VK_STRUCTURE_TYPE_FORMAT_PROPERTIES_3
  , VkFormatFeatureFlags2
  , VkFormatFeatureFlagBits2
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_BIT
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_STORAGE_IMAGE_BIT
  , pattern VK_FORMAT_FEATURE_2_STORAGE_IMAGE_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_STORAGE_IMAGE_ATOMIC_BIT
  , pattern VK_FORMAT_FEATURE_2_STORAGE_IMAGE_ATOMIC_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_UNIFORM_TEXEL_BUFFER_BIT
  , pattern VK_FORMAT_FEATURE_2_UNIFORM_TEXEL_BUFFER_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_BIT
  , pattern VK_FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_ATOMIC_BIT
  , pattern VK_FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_ATOMIC_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_VERTEX_BUFFER_BIT
  , pattern VK_FORMAT_FEATURE_2_VERTEX_BUFFER_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_COLOR_ATTACHMENT_BIT
  , pattern VK_FORMAT_FEATURE_2_COLOR_ATTACHMENT_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_COLOR_ATTACHMENT_BLEND_BIT
  , pattern VK_FORMAT_FEATURE_2_COLOR_ATTACHMENT_BLEND_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_DEPTH_STENCIL_ATTACHMENT_BIT
  , pattern VK_FORMAT_FEATURE_2_DEPTH_STENCIL_ATTACHMENT_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_BLIT_SRC_BIT
  , pattern VK_FORMAT_FEATURE_2_BLIT_SRC_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_BLIT_DST_BIT
  , pattern VK_FORMAT_FEATURE_2_BLIT_DST_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_LINEAR_BIT
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_LINEAR_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_CUBIC_BIT
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_CUBIC_BIT_EXT
  , pattern VK_FORMAT_FEATURE_2_TRANSFER_SRC_BIT
  , pattern VK_FORMAT_FEATURE_2_TRANSFER_SRC_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_TRANSFER_DST_BIT
  , pattern VK_FORMAT_FEATURE_2_TRANSFER_DST_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_MINMAX_BIT
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_MINMAX_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_MIDPOINT_CHROMA_SAMPLES_BIT
  , pattern VK_FORMAT_FEATURE_2_MIDPOINT_CHROMA_SAMPLES_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_DISJOINT_BIT
  , pattern VK_FORMAT_FEATURE_2_DISJOINT_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_COSITED_CHROMA_SAMPLES_BIT
  , pattern VK_FORMAT_FEATURE_2_COSITED_CHROMA_SAMPLES_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_STORAGE_READ_WITHOUT_FORMAT_BIT
  , pattern VK_FORMAT_FEATURE_2_STORAGE_READ_WITHOUT_FORMAT_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_STORAGE_WRITE_WITHOUT_FORMAT_BIT
  , pattern VK_FORMAT_FEATURE_2_STORAGE_WRITE_WITHOUT_FORMAT_BIT_KHR
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_DEPTH_COMPARISON_BIT
  , pattern VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_DEPTH_COMPARISON_BIT_KHR
  , VkFormatProperties3 (..)

  -- | Promoted from VK_EXT_extended_dynamic_state2 (Feature struct and optional state are not promoted) (extension 378)
  , pattern VK_DYNAMIC_STATE_RASTERIZER_DISCARD_ENABLE
  , pattern VK_DYNAMIC_STATE_DEPTH_BIAS_ENABLE
  , pattern VK_DYNAMIC_STATE_PRIMITIVE_RESTART_ENABLE
  , VkCmdSetRasterizerDiscardEnable
  , vkFunCmdSetRasterizerDiscardEnable
##if CORE_1_3
  , vkCmdSetRasterizerDiscardEnable
  , vkCmdSetRasterizerDiscardEnableUnsafe
##endif
  , VkCmdSetDepthBiasEnable
  , vkFunCmdSetDepthBiasEnable
##if CORE_1_3
  , vkCmdSetDepthBiasEnable
  , vkCmdSetDepthBiasEnableUnsafe
##endif
  , VkCmdSetPrimitiveRestartEnable
  , vkFunCmdSetPrimitiveRestartEnable
##if CORE_1_3
  , vkCmdSetPrimitiveRestartEnable
...
##endif
  ...
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_4_FEATURES
  , pattern VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_4_PROPERTIES
  , pattern VK_STRUCTURE_TYPE_DEVICE_BUFFER_MEMORY_REQUIREMENTS
  , pattern VK_STRUCTURE_TYPE_DEVICE_IMAGE_MEMORY_REQUIREMENTS
  , pattern VK_IMAGE_ASPECT_NONE
  , VkPhysicalDeviceMaintenance4Features (..)
  , VkPhysicalDeviceMaintenance4Properties (..)
  , VkDeviceBufferMemoryRequirements (..)
  , VkDeviceImageMemoryRequirements (..)
  , VkGetDeviceBufferMemoryRequirements
  , vkFunGetDeviceBufferMemoryRequirements
##if CORE_1_3
  , vkGetDeviceBufferMemoryRequirements
  , vkGetDeviceBufferMemoryRequirementsUnsafe
##endif
  , VkGetDeviceImageMemoryRequirements
  , vkFunGetDeviceImageMemoryRequirements
##if CORE_1_3
  , vkGetDeviceImageMemoryRequirements
  , vkGetDeviceImageMemoryRequirementsUnsafe
##endif
  , VkGetDeviceImageSparseMemoryRequirements
  , vkFunGetDeviceImageSparseMemoryRequirements
##if CORE_1_3
  , vkGetDeviceImageSparseMemoryRequirements
...
import Vulkan.Types.Enum.VkPipelineCreationFeedbackFlagBits
...
import Vulkan.Types.Struct.VkCommandBufferInheritanceRenderingInfo
...
import Vulkan.Types.Struct.VkDevicePrivateDataCreateInfo
...
import Vulkan.Types.Struct.VkFormatProperties3
...
import Vulkan.Types.Struct.VkPhysicalDeviceDynamicRenderingFeatures
...
import Vulkan.Types.Struct.VkPhysicalDeviceImageRobustnessFeatures
...
import Vulkan.Types.Struct.VkPhysicalDeviceMaintenance4Features
import Vulkan.Types.Struct.VkPhysicalDeviceMaintenance4Properties
...
import Vulkan.Types.Struct.VkPhysicalDevicePrivateDataFeatures
...
import Vulkan.Types.Struct.VkPhysicalDeviceSynchronization2Features
...
import Vulkan.Types.Struct.VkPhysicalDeviceVulkan13Features
import Vulkan.Types.Struct.VkPhysicalDeviceVulkan13Properties
...
import Vulkan.Types.Struct.VkPipelineCreationFeedbackCreateInfo
...
import Vulkan.Types.Struct.VkPipelineRenderingCreateInfo
...
import Vulkan.Types.Struct.VkWriteDescriptorSetInlineUniformBlock
