...
instance Storable VkVideoEncodeH265CapabilitiesEXT where
  ...
  peek ptr = 
    VkVideoEncodeH265CapabilitiesEXT
       ...
       <*> peek (offset @"ctbSizes" ptr)
       <*> peek (offset @"transformBlockSizes" ptr)
       ...
       <*> peek (offset @"maxSubLayersCount" ptr)
       <*> peek (offset @"minLog2MinLumaCodingBlockSizeMinus3" ptr)
       <*> peek (offset @"maxLog2MinLumaCodingBlockSizeMinus3" ptr)
       <*> peek (offset @"minLog2MinLumaTransformBlockSizeMinus2" ptr)
       <*> peek (offset @"maxLog2MinLumaTransformBlockSizeMinus2" ptr)
       <*> peek (offset @"minMaxTransformHierarchyDepthInter" ptr)
       <*> peek (offset @"maxMaxTransformHierarchyDepthInter" ptr)
       <*> peek (offset @"minMaxTransformHierarchyDepthIntra" ptr)
       <*> peek (offset @"maxMaxTransformHierarchyDepthIntra" ptr)
       <*> peek (offset @"maxDiffCuQpDeltaDepth" ptr)
       <*> peek (offset @"minMaxNumMergeCand" ptr)
       <*> peek (offset @"maxMaxNumMergeCand" ptr)
