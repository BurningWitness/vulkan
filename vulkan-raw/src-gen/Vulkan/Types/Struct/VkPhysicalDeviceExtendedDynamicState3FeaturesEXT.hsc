...
instance Storable VkPhysicalDeviceExtendedDynamicState3FeaturesEXT where
  ...
  peek ptr = 
    VkPhysicalDeviceExtendedDynamicState3FeaturesEXT
       ...
       <*> peek (offset @"extendedDynamicState3TessellationDomainOrigin" ptr)
       <*> peek (offset @"extendedDynamicState3DepthClampEnable" ptr)
       <*> peek (offset @"extendedDynamicState3PolygonMode" ptr)
       <*> peek (offset @"extendedDynamicState3RasterizationSamples" ptr)
       <*> peek (offset @"extendedDynamicState3SampleMask" ptr)
       <*> peek (offset @"extendedDynamicState3AlphaToCoverageEnable" ptr)
       <*> peek (offset @"extendedDynamicState3AlphaToOneEnable" ptr)
       <*> peek (offset @"extendedDynamicState3LogicOpEnable" ptr)
       <*> peek (offset @"extendedDynamicState3ColorBlendEnable" ptr)
       <*> peek (offset @"extendedDynamicState3ColorBlendEquation" ptr)
       <*> peek (offset @"extendedDynamicState3ColorWriteMask" ptr)
       <*> peek (offset @"extendedDynamicState3RasterizationStream" ptr)
       <*> peek (offset @"extendedDynamicState3ConservativeRasterizationMode" ptr)
       <*> peek (offset @"extendedDynamicState3ExtraPrimitiveOverestimationSize" ptr)
       <*> peek (offset @"extendedDynamicState3DepthClipEnable" ptr)
       <*> peek (offset @"extendedDynamicState3SampleLocationsEnable" ptr)
       <*> peek (offset @"extendedDynamicState3ColorBlendAdvanced" ptr)
       <*> peek (offset @"extendedDynamicState3ProvokingVertexMode" ptr)
       <*> peek (offset @"extendedDynamicState3LineRasterizationMode" ptr)
       <*> peek (offset @"extendedDynamicState3LineStippleEnable" ptr)
       <*> peek (offset @"extendedDynamicState3DepthClipNegativeOneToOne" ptr)
       <*> peek (offset @"extendedDynamicState3ViewportWScalingEnable" ptr)
       <*> peek (offset @"extendedDynamicState3ViewportSwizzle" ptr)
       <*> peek (offset @"extendedDynamicState3CoverageToColorEnable" ptr)
       <*> peek (offset @"extendedDynamicState3CoverageToColorLocation" ptr)
       <*> peek (offset @"extendedDynamicState3CoverageModulationMode" ptr)
       <*> peek (offset @"extendedDynamicState3CoverageModulationTableEnable" ptr)
       <*> peek (offset @"extendedDynamicState3CoverageModulationTable" ptr)
       <*> peek (offset @"extendedDynamicState3CoverageReductionMode" ptr)
       <*> peek (offset @"extendedDynamicState3RepresentativeFragmentTestEnable" ptr)
       <*> peek (offset @"extendedDynamicState3ShadingRateImageEnable" ptr)
