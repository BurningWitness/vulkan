...
instance Storable VkPhysicalDeviceLimits where
  ...
  peek ptr = 
    VkPhysicalDeviceLimits
       <$> peek (Foreign.Storable.Offset.offset @"maxImageDimension1D" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxImageDimension2D" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxImageDimension3D" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxImageDimensionCube" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxImageArrayLayers" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxTexelBufferElements" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxUniformBufferRange" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxStorageBufferRange" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxPushConstantsSize" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxMemoryAllocationCount" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxSamplerAllocationCount" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"bufferImageGranularity" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"sparseAddressSpaceSize" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxBoundDescriptorSets" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxPerStageDescriptorSamplers" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxPerStageDescriptorUniformBuffers" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxPerStageDescriptorStorageBuffers" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxPerStageDescriptorSampledImages" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxPerStageDescriptorStorageImages" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxPerStageDescriptorInputAttachments" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxPerStageResources" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxDescriptorSetSamplers" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxDescriptorSetUniformBuffers" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxDescriptorSetUniformBuffersDynamic" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxDescriptorSetStorageBuffers" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxDescriptorSetStorageBuffersDynamic" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxDescriptorSetSampledImages" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxDescriptorSetStorageImages" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxDescriptorSetInputAttachments" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxVertexInputAttributes" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxVertexInputBindings" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxVertexInputAttributeOffset" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxVertexInputBindingStride" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxVertexOutputComponents" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxTessellationGenerationLevel" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxTessellationPatchSize" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxTessellationControlPerVertexInputComponents" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxTessellationControlPerVertexOutputComponents" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxTessellationControlPerPatchOutputComponents" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxTessellationControlTotalOutputComponents" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxTessellationEvaluationInputComponents" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxTessellationEvaluationOutputComponents" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxGeometryShaderInvocations" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxGeometryInputComponents" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxGeometryOutputComponents" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxGeometryOutputVertices" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxGeometryTotalOutputComponents" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxFragmentInputComponents" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxFragmentOutputAttachments" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxFragmentDualSrcAttachments" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxFragmentCombinedOutputResources" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxComputeSharedMemorySize" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxComputeWorkGroupCount" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxComputeWorkGroupInvocations" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxComputeWorkGroupSize" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"subPixelPrecisionBits" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"subTexelPrecisionBits" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"mipmapPrecisionBits" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxDrawIndexedIndexValue" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxDrawIndirectCount" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxSamplerLodBias" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxSamplerAnisotropy" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxViewports" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxViewportDimensions" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"viewportBoundsRange" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"viewportSubPixelBits" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"minMemoryMapAlignment" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"minTexelBufferOffsetAlignment" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"minUniformBufferOffsetAlignment" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"minStorageBufferOffsetAlignment" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"minTexelOffset" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxTexelOffset" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"minTexelGatherOffset" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxTexelGatherOffset" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"minInterpolationOffset" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxInterpolationOffset" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"subPixelInterpolationOffsetBits" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxFramebufferWidth" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxFramebufferHeight" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxFramebufferLayers" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"framebufferColorSampleCounts" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"framebufferDepthSampleCounts" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"framebufferStencilSampleCounts" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"framebufferNoAttachmentsSampleCounts" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxColorAttachments" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"sampledImageColorSampleCounts" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"sampledImageIntegerSampleCounts" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"sampledImageDepthSampleCounts" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"sampledImageStencilSampleCounts" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"storageImageSampleCounts" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxSampleMaskWords" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"timestampComputeAndGraphics" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"timestampPeriod" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxClipDistances" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxCullDistances" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"maxCombinedClipAndCullDistances" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"discreteQueuePriorities" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"pointSizeRange" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"lineWidthRange" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"pointSizeGranularity" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"lineWidthGranularity" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"strictLines" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"standardSampleLocations" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"optimalBufferCopyOffsetAlignment" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"optimalBufferCopyRowPitchAlignment" ptr)
       <*> peek (Foreign.Storable.Offset.offset @"nonCoherentAtomSize" ptr)
