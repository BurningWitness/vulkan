...
pattern VK_DYNAMIC_STATE_CULL_MODE_EXT = 1000267000
#endif

#if VK_EXT_extended_dynamic_state
pattern VK_DYNAMIC_STATE_FRONT_FACE_EXT :: (Eq a, Num a) => a
pattern VK_DYNAMIC_STATE_FRONT_FACE_EXT = 1000267001
#endif

#if VK_EXT_extended_dynamic_state
pattern VK_DYNAMIC_STATE_PRIMITIVE_TOPOLOGY_EXT :: (Eq a, Num a) => a
pattern VK_DYNAMIC_STATE_PRIMITIVE_TOPOLOGY_EXT = 1000267002
#endif

#if VK_EXT_extended_dynamic_state
pattern VK_DYNAMIC_STATE_VIEWPORT_WITH_COUNT_EXT :: (Eq a, Num a) => a
pattern VK_DYNAMIC_STATE_VIEWPORT_WITH_COUNT_EXT = 1000267003
#endif

#if VK_EXT_extended_dynamic_state
pattern VK_DYNAMIC_STATE_SCISSOR_WITH_COUNT_EXT :: (Eq a, Num a) => a
pattern VK_DYNAMIC_STATE_SCISSOR_WITH_COUNT_EXT = 1000267004
#endif

#if VK_EXT_extended_dynamic_state
pattern VK_DYNAMIC_STATE_VERTEX_INPUT_BINDING_STRIDE_EXT :: (Eq a, Num a) => a
pattern VK_DYNAMIC_STATE_VERTEX_INPUT_BINDING_STRIDE_EXT = 1000267005
#endif

#if VK_EXT_extended_dynamic_state
pattern VK_DYNAMIC_STATE_DEPTH_TEST_ENABLE_EXT :: (Eq a, Num a) => a
pattern VK_DYNAMIC_STATE_DEPTH_TEST_ENABLE_EXT = 1000267006
#endif

#if VK_EXT_extended_dynamic_state
pattern VK_DYNAMIC_STATE_DEPTH_WRITE_ENABLE_EXT :: (Eq a, Num a) => a
pattern VK_DYNAMIC_STATE_DEPTH_WRITE_ENABLE_EXT = 1000267007
#endif

#if VK_EXT_extended_dynamic_state
pattern VK_DYNAMIC_STATE_DEPTH_COMPARE_OP_EXT :: (Eq a, Num a) => a
pattern VK_DYNAMIC_STATE_DEPTH_COMPARE_OP_EXT = 1000267008
#endif

#if VK_EXT_extended_dynamic_state
pattern VK_DYNAMIC_STATE_DEPTH_BOUNDS_TEST_ENABLE_EXT :: (Eq a, Num a) => a
pattern VK_DYNAMIC_STATE_DEPTH_BOUNDS_TEST_ENABLE_EXT = 1000267009
#endif

#if VK_EXT_extended_dynamic_state
pattern VK_DYNAMIC_STATE_STENCIL_TEST_ENABLE_EXT :: (Eq a, Num a) => a
pattern VK_DYNAMIC_STATE_STENCIL_TEST_ENABLE_EXT = 1000267010
#endif

#if VK_EXT_extended_dynamic_state
pattern VK_DYNAMIC_STATE_STENCIL_OP_EXT :: (Eq a, Num a) => a
pattern VK_DYNAMIC_STATE_STENCIL_OP_EXT = 1000267011
#endif
...
pattern VK_DYNAMIC_STATE_RASTERIZER_DISCARD_ENABLE_EXT = 1000377001
#endif

#if VK_EXT_extended_dynamic_state2
pattern VK_DYNAMIC_STATE_DEPTH_BIAS_ENABLE_EXT :: (Eq a, Num a) => a
pattern VK_DYNAMIC_STATE_DEPTH_BIAS_ENABLE_EXT = 1000377002
#endif
...
pattern VK_DYNAMIC_STATE_PRIMITIVE_RESTART_ENABLE_EXT = 1000377004
#endif
