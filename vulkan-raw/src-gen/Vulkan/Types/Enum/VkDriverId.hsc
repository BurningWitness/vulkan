...
pattern VK_DRIVER_ID_AMD_PROPRIETARY_KHR = VK_DRIVER_ID_AMD_PROPRIETARY
#endif

#if VK_KHR_driver_properties
pattern VK_DRIVER_ID_AMD_OPEN_SOURCE_KHR :: (Eq a, Num a) => a
pattern VK_DRIVER_ID_AMD_OPEN_SOURCE_KHR = VK_DRIVER_ID_AMD_OPEN_SOURCE
#endif
...
pattern VK_DRIVER_ID_NVIDIA_PROPRIETARY_KHR = VK_DRIVER_ID_NVIDIA_PROPRIETARY
#endif

#if VK_KHR_driver_properties
pattern VK_DRIVER_ID_INTEL_PROPRIETARY_WINDOWS_KHR :: (Eq a, Num a) => a
pattern VK_DRIVER_ID_INTEL_PROPRIETARY_WINDOWS_KHR = VK_DRIVER_ID_INTEL_PROPRIETARY_WINDOWS
#endif

#if VK_KHR_driver_properties
pattern VK_DRIVER_ID_INTEL_OPEN_SOURCE_MESA_KHR :: (Eq a, Num a) => a
pattern VK_DRIVER_ID_INTEL_OPEN_SOURCE_MESA_KHR = VK_DRIVER_ID_INTEL_OPEN_SOURCE_MESA
#endif

#if VK_KHR_driver_properties
pattern VK_DRIVER_ID_IMAGINATION_PROPRIETARY_KHR :: (Eq a, Num a) => a
pattern VK_DRIVER_ID_IMAGINATION_PROPRIETARY_KHR = VK_DRIVER_ID_IMAGINATION_PROPRIETARY
#endif

#if VK_KHR_driver_properties
pattern VK_DRIVER_ID_QUALCOMM_PROPRIETARY_KHR :: (Eq a, Num a) => a
pattern VK_DRIVER_ID_QUALCOMM_PROPRIETARY_KHR = VK_DRIVER_ID_QUALCOMM_PROPRIETARY
#endif

#if VK_KHR_driver_properties
pattern VK_DRIVER_ID_ARM_PROPRIETARY_KHR :: (Eq a, Num a) => a
pattern VK_DRIVER_ID_ARM_PROPRIETARY_KHR = VK_DRIVER_ID_ARM_PROPRIETARY
#endif

#if VK_KHR_driver_properties
pattern VK_DRIVER_ID_GOOGLE_SWIFTSHADER_KHR :: (Eq a, Num a) => a
pattern VK_DRIVER_ID_GOOGLE_SWIFTSHADER_KHR = VK_DRIVER_ID_GOOGLE_SWIFTSHADER
#endif

#if VK_KHR_driver_properties
pattern VK_DRIVER_ID_GGP_PROPRIETARY_KHR :: (Eq a, Num a) => a
pattern VK_DRIVER_ID_GGP_PROPRIETARY_KHR = VK_DRIVER_ID_GGP_PROPRIETARY
#endif

#if VK_KHR_driver_properties
pattern VK_DRIVER_ID_BROADCOM_PROPRIETARY_KHR :: (Eq a, Num a) => a
pattern VK_DRIVER_ID_BROADCOM_PROPRIETARY_KHR = VK_DRIVER_ID_BROADCOM_PROPRIETARY
#endif