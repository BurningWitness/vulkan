...
pattern VK_COPY_ACCELERATION_STRUCTURE_MODE_CLONE_NV = VK_COPY_ACCELERATION_STRUCTURE_MODE_CLONE_KHR
#endif

#if VK_NV_ray_tracing
pattern VK_COPY_ACCELERATION_STRUCTURE_MODE_COMPACT_NV :: (Eq a, Num a) => a
pattern VK_COPY_ACCELERATION_STRUCTURE_MODE_COMPACT_NV = VK_COPY_ACCELERATION_STRUCTURE_MODE_COMPACT_KHR
#endif