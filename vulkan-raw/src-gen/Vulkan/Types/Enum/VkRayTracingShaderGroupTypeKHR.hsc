...
pattern VK_RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_NV = 0
#endif

#if VK_KHR_ray_tracing_pipeline
pattern VK_RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_NV :: (Eq a, Num a) => a
pattern VK_RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_NV = 1
#endif

#if VK_KHR_ray_tracing_pipeline
pattern VK_RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_NV :: (Eq a, Num a) => a
pattern VK_RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_NV = 2
#endif