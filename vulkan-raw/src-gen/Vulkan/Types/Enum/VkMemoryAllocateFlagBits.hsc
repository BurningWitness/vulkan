...
pattern VK_MEMORY_ALLOCATE_DEVICE_MASK_BIT_KHR = 1
#endif

#if VK_KHR_buffer_device_address
pattern VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT_KHR :: (Eq a, Num a) => a
pattern VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT_KHR = 2
#endif

#if VK_KHR_buffer_device_address
pattern VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR :: (Eq a, Num a) => a
pattern VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR = 4
#endif