...
pattern VK_PIPELINE_STAGE_SHADING_RATE_IMAGE_BIT_NV = VK_PIPELINE_STAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR
#endif

#if VK_NV_ray_tracing
pattern VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_NV :: (Eq a, Num a) => a
pattern VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_NV = VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_KHR
#endif

#if VK_NV_ray_tracing
pattern VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_NV :: (Eq a, Num a) => a
pattern VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_NV = VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_KHR
#endif

#if VK_NV_mesh_shader
pattern VK_PIPELINE_STAGE_TASK_SHADER_BIT_NV :: (Eq a, Num a) => a
pattern VK_PIPELINE_STAGE_TASK_SHADER_BIT_NV = VK_PIPELINE_STAGE_TASK_SHADER_BIT_EXT
#endif

#if VK_NV_mesh_shader
pattern VK_PIPELINE_STAGE_MESH_SHADER_BIT_NV :: (Eq a, Num a) => a
pattern VK_PIPELINE_STAGE_MESH_SHADER_BIT_NV = VK_PIPELINE_STAGE_MESH_SHADER_BIT_EXT
#endif
...
pattern VK_PIPELINE_STAGE_NONE_KHR = VK_PIPELINE_STAGE_NONE
#endif
