...
pattern VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_CUBIC_BIT_IMG = 8192
#endif
...
pattern VK_FORMAT_FEATURE_TRANSFER_SRC_BIT_KHR = 16384
#endif

#if VK_KHR_maintenance1
pattern VK_FORMAT_FEATURE_TRANSFER_DST_BIT_KHR :: (Eq a, Num a) => a
pattern VK_FORMAT_FEATURE_TRANSFER_DST_BIT_KHR = 32768
#endif

#if VK_EXT_sampler_filter_minmax
pattern VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_MINMAX_BIT_EXT :: (Eq a, Num a) => a
pattern VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_MINMAX_BIT_EXT = 65536
#endif
...
pattern VK_FORMAT_FEATURE_MIDPOINT_CHROMA_SAMPLES_BIT_KHR = 131072
#endif

#if VK_KHR_sampler_ycbcr_conversion
pattern VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT_KHR :: (Eq a, Num a) => a
pattern VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT_KHR = 262144
#endif

#if VK_KHR_sampler_ycbcr_conversion
pattern VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT_KHR :: (Eq a, Num a) => a
pattern VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT_KHR = 524288
#endif

#if VK_KHR_sampler_ycbcr_conversion
pattern VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT_KHR :: (Eq a, Num a) => a
pattern VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT_KHR = 1048576
#endif

#if VK_KHR_sampler_ycbcr_conversion
pattern VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT_KHR :: (Eq a, Num a) => a
pattern VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT_KHR = 2097152
#endif

#if VK_KHR_sampler_ycbcr_conversion
pattern VK_FORMAT_FEATURE_DISJOINT_BIT_KHR :: (Eq a, Num a) => a
pattern VK_FORMAT_FEATURE_DISJOINT_BIT_KHR = 4194304
#endif

#if VK_KHR_sampler_ycbcr_conversion
pattern VK_FORMAT_FEATURE_COSITED_CHROMA_SAMPLES_BIT_KHR :: (Eq a, Num a) => a
pattern VK_FORMAT_FEATURE_COSITED_CHROMA_SAMPLES_BIT_KHR = 8388608
#endif
