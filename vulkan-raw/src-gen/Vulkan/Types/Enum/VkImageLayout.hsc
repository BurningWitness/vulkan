...
pattern VK_IMAGE_LAYOUT_SHADING_RATE_OPTIMAL_NV = VK_IMAGE_LAYOUT_FRAGMENT_SHADING_RATE_ATTACHMENT_OPTIMAL_KHR
#endif
...
pattern VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_OPTIMAL_KHR = VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_OPTIMAL
#endif

#if VK_KHR_separate_depth_stencil_layouts
pattern VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_OPTIMAL_KHR :: (Eq a, Num a) => a
pattern VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_OPTIMAL_KHR = VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_OPTIMAL
#endif

#if VK_KHR_separate_depth_stencil_layouts
pattern VK_IMAGE_LAYOUT_STENCIL_ATTACHMENT_OPTIMAL_KHR :: (Eq a, Num a) => a
pattern VK_IMAGE_LAYOUT_STENCIL_ATTACHMENT_OPTIMAL_KHR = VK_IMAGE_LAYOUT_STENCIL_ATTACHMENT_OPTIMAL
#endif

#if VK_KHR_separate_depth_stencil_layouts
pattern VK_IMAGE_LAYOUT_STENCIL_READ_ONLY_OPTIMAL_KHR :: (Eq a, Num a) => a
pattern VK_IMAGE_LAYOUT_STENCIL_READ_ONLY_OPTIMAL_KHR = VK_IMAGE_LAYOUT_STENCIL_READ_ONLY_OPTIMAL
#endif
...
pattern VK_IMAGE_LAYOUT_READ_ONLY_OPTIMAL_KHR = VK_IMAGE_LAYOUT_READ_ONLY_OPTIMAL
#endif

#if VK_KHR_synchronization2
pattern VK_IMAGE_LAYOUT_ATTACHMENT_OPTIMAL_KHR :: (Eq a, Num a) => a
pattern VK_IMAGE_LAYOUT_ATTACHMENT_OPTIMAL_KHR = VK_IMAGE_LAYOUT_ATTACHMENT_OPTIMAL
#endif
