...
pattern VK_IMAGE_CREATE_SPLIT_INSTANCE_BIND_REGIONS_BIT_KHR = 64
#endif

#if VK_KHR_maintenance1
pattern VK_IMAGE_CREATE_2D_ARRAY_COMPATIBLE_BIT_KHR :: (Eq a, Num a) => a
pattern VK_IMAGE_CREATE_2D_ARRAY_COMPATIBLE_BIT_KHR = 32
#endif

#if VK_KHR_maintenance2
pattern VK_IMAGE_CREATE_BLOCK_TEXEL_VIEW_COMPATIBLE_BIT_KHR :: (Eq a, Num a) => a
pattern VK_IMAGE_CREATE_BLOCK_TEXEL_VIEW_COMPATIBLE_BIT_KHR = 128
#endif

#if VK_KHR_maintenance2
pattern VK_IMAGE_CREATE_EXTENDED_USAGE_BIT_KHR :: (Eq a, Num a) => a
pattern VK_IMAGE_CREATE_EXTENDED_USAGE_BIT_KHR = 256
#endif
...
pattern VK_IMAGE_CREATE_DISJOINT_BIT_KHR = 512
#endif

#if VK_KHR_bind_memory2
pattern VK_IMAGE_CREATE_ALIAS_BIT_KHR :: (Eq a, Num a) => a
pattern VK_IMAGE_CREATE_ALIAS_BIT_KHR = 1024
#endif
