...
pattern VK_QUEUE_GLOBAL_PRIORITY_LOW_EXT = 128
#endif

#if VK_KHR_global_priority
pattern VK_QUEUE_GLOBAL_PRIORITY_MEDIUM_EXT :: (Eq a, Num a) => a
pattern VK_QUEUE_GLOBAL_PRIORITY_MEDIUM_EXT = 256
#endif

#if VK_KHR_global_priority
pattern VK_QUEUE_GLOBAL_PRIORITY_HIGH_EXT :: (Eq a, Num a) => a
pattern VK_QUEUE_GLOBAL_PRIORITY_HIGH_EXT = 512
#endif

#if VK_KHR_global_priority
pattern VK_QUEUE_GLOBAL_PRIORITY_REALTIME_EXT :: (Eq a, Num a) => a
pattern VK_QUEUE_GLOBAL_PRIORITY_REALTIME_EXT = 1024
#endif