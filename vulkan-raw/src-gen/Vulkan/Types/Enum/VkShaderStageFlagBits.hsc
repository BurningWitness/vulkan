...
pattern VK_SHADER_STAGE_RAYGEN_BIT_NV = VK_SHADER_STAGE_RAYGEN_BIT_KHR
#endif

#if VK_NV_ray_tracing
pattern VK_SHADER_STAGE_ANY_HIT_BIT_NV :: (Eq a, Num a) => a
pattern VK_SHADER_STAGE_ANY_HIT_BIT_NV = VK_SHADER_STAGE_ANY_HIT_BIT_KHR
#endif

#if VK_NV_ray_tracing
pattern VK_SHADER_STAGE_CLOSEST_HIT_BIT_NV :: (Eq a, Num a) => a
pattern VK_SHADER_STAGE_CLOSEST_HIT_BIT_NV = VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR
#endif
...
pattern VK_SHADER_STAGE_INTERSECTION_BIT_NV = VK_SHADER_STAGE_INTERSECTION_BIT_KHR
#endif

#if VK_NV_ray_tracing
pattern VK_SHADER_STAGE_CALLABLE_BIT_NV :: (Eq a, Num a) => a
pattern VK_SHADER_STAGE_CALLABLE_BIT_NV = VK_SHADER_STAGE_CALLABLE_BIT_KHR
#endif

#if VK_NV_mesh_shader
pattern VK_SHADER_STAGE_TASK_BIT_NV :: (Eq a, Num a) => a
pattern VK_SHADER_STAGE_TASK_BIT_NV = VK_SHADER_STAGE_TASK_BIT_EXT
#endif

#if VK_NV_mesh_shader
pattern VK_SHADER_STAGE_MESH_BIT_NV :: (Eq a, Num a) => a
pattern VK_SHADER_STAGE_MESH_BIT_NV = VK_SHADER_STAGE_MESH_BIT_EXT
#endif
