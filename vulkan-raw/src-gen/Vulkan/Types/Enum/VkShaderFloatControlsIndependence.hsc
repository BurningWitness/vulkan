...
pattern VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_32_BIT_ONLY_KHR = VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_32_BIT_ONLY
#endif

#if VK_KHR_shader_float_controls
pattern VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_ALL_KHR :: (Eq a, Num a) => a
pattern VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_ALL_KHR = VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_ALL
#endif

#if VK_KHR_shader_float_controls
pattern VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_NONE_KHR :: (Eq a, Num a) => a
pattern VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_NONE_KHR = VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_NONE
#endif