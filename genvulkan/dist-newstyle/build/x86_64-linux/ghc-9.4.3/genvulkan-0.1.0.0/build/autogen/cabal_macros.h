...
/* package genvulkan-0.1.0.0 */
#ifndef VERSION_genvulkan
#define VERSION_genvulkan "0.1.0.0"
#endif /* VERSION_genvulkan */
#ifndef MIN_VERSION_genvulkan
#define MIN_VERSION_genvulkan(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_genvulkan */
/* package HaXml-1.25.12 */
#ifndef VERSION_HaXml
#define VERSION_HaXml "1.25.12"
#endif /* VERSION_HaXml */
#ifndef MIN_VERSION_HaXml
#define MIN_VERSION_HaXml(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  25 || \
  (major1) == 1 && (major2) == 25 && (minor) <= 12)
...
#define CURRENT_PACKAGE_KEY "genvulkan-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "genvulkan-0.1.0.0-inplace"
